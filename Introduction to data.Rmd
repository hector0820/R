...
```{r hist-dep-delay, echo=FALSE}
ggplot(nycflights, aes(x = dep_delay)) + geom_histogram(binwidth = 30)
```
...
<ol>
<li> <mark style="background: lightgreen;">68 </mark></li> 
<li> 1345 </li> 
<li> 2286 </li> 
<li> 3563 </li>
<li> 32735 </li>
...
<li> <mark style="background:lightgreen;">No flight is delayed more than 2 hours. </mark></li> 
...
sfo_feb_flights %>%
  summarise(mean_dd = mean(arr_delay), median_dd = median(arr_delay),sd_dd = sd(arr_delay), n = n())
...
<li> <mark style="background: lightgreen;">Delta and United Airlines </mark></li>
...
<li> January </li> 
<li> March </li> 
<li> <mark style="background: lightgreen;">July </mark></li> 
<li> October </li>
<li> December </li>
</ol>
...
<li> July </li> 
<li> October </li>
<li> <mark style="background:lightgreen;">December </mark></li>
</ol>
...
nycflights %>%
  ...
  arrange(desc(median_dd)) |> head(n=5)
```
...
<li> <mark style="background: lightgreen;">Median would be more reliable as the distribution of delays is skewed. </mark></li> 
...
<li> EWR </li> 
<li> JFK </li> 
<li> <mark style="background: lightgreen;">LGA </mark></li> 
</ol>
...
<ol>
<li> <mark style="background:lightgreen;">N666DN </mark></li> 
<li> N755US </li> 
<li> N779JB </li> 
<li> N947UW </li> 
<li> N959UW </li> 
...
nycflights %>%
  ...
  arrange(desc(avg_speed)) %>% head(n=5)
```
...
<li> <mark style="background: lightgreen;">There is an overall postive association between distance and average speed.</mark></li> 
...
```{r on-time-arr-perc}
nycflights |> 
  mutate(dep_type = ifelse(dep_delay >= 5, "delayed", "on time")) |>
  mutate(arr_type = ifelse(arr_delay <= 0, "on time", "delayed")) |>
  filter(dep_type == "delayed") |>
  summarise(on_time = sum(arr_type == "on time") / n(), n = n())
```
